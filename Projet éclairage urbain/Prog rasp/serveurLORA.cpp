...
int SERVEURLORA::ouvrir(string nomDuPortSerie)
{  
...
/********************************************************************************
*	SOUS-PROGRAMME fermer DE LA CLASSE SERVEURLORA			*
*		DONNEES EN ENTREE :						*
...
/********************************************************************************
*	SOUS-PROGRAMME envoyerCaractere DE LA CLASSE SERVEURLORA		*
...
********************************************************************************/
bool SERVEURLORA::envoyerCaractere(const char c) const
{
...
/********************************************************************************
*	SOUS-PROGRAMME envoyerTrame DE LA CLASSE SERVEURLORA		*
...
* 	Cette méthode renvoie FAUX en cas d'erreur, VRAI sinon.                 *
********************************************************************************/
bool SERVEURLORA::envoyerTrame(const char trame[]) const
{
...
bool SERVEURLORA::envoyerTrame(string trame) const
{
...
int SERVEURLORA::lireMessage(char message[], int tailleMaximaleDuMessage) const
{
	int nbOctet=0;
...
string SERVEURLORA::lireMessage() const
{
	char msg[1024];
	int nbOctet=0;
	// cout << "Attente d'un message" << endl;
...
/*int SERVEURLORA::lireMessageMieux(char message[], int tailleMaximaleDuMessage) const
{
    int nbOctetsLus=0;
    int res;
    int tmp = 0;
...
int SERVEURLORA::lireMessageACK(char message[], int tailleMaximaleDuMessage) const
{
    int nbOctetsLus=0;
    int nbOctetsALire = 3;
    do
